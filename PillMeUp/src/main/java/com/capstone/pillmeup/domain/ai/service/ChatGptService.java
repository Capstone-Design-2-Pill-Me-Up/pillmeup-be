...
public class ChatGptService {
    ...
    public String generateDetailField(String itemName, String entpName, String fieldName) {
        ...
        String prompt = String.format("""
            ...
            '%s' 항목에 들어갈 내용을 약리학적 근거를 포함하여 작성해줘.
            성분의 작용 기전, 인체 내 대사 경로, 부작용 가능성 등을 고려하여
            실제 약리학 논문 요약처럼 전문적으로 기술한다.
            존칭은 쓰지 않고, '~할 수 있습니다.', '~유발합니다.' 등의 서술형으로 마무리한다.

            예시:
            - 효능/효과: "에페드린은 교감신경 흥분 작용을 통해 기관지 확장을 유도하고 혈압을 상승시킵니다."
            - 부작용: "혈압 상승, 불면, 두근거림이 나타날 수 있으며 장기 복용 시 심혈관계 부담이 증가할 수 있습니다."
            - 주의사항: "고혈압, 갑상선 기능 항진증 환자는 교감신경 자극 작용으로 증상이 악화될 수 있으므로 복용 시 주의해야 합니다."
